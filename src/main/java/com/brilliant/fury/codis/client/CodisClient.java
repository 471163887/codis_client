 ...
 */
@Slf4j
public class CodisClient implements JedisCommands {

    private JedisPoolManager poolManager = JedisPoolManager.getInstance();

    public static CodisClient getInstance() {
        return codisClient;
    }

    private static CodisClient codisClient = new CodisClient();
    ...
    public String set(String key, String value) {
        try (Jedis jedis = poolManager.getJedis()) {
